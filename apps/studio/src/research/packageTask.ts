import { decodeVolumeTaskState, type VolumeTaskStates, type VolumeTaskState } from "./packageState";
import { textVersion } from "@bcr/core";
import { decodeResearchBackup } from "./backup";
import { decodeVolumeCatalog, matchesVolumeBook, groupBooksByVolume } from "./volumes";
import type { ResearchPackagePlan } from "./package";
